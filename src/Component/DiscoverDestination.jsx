		...
		<section className=" dark:bg-gray-100 dark:text-gray-800 mt-32">
			<div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
				<div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
					<div>
						<h3 className="text-2xl md:text-4xl font-bold tracking-tight text-gray-900 dark:text-white ">Discover your all the destinations with us!</h3>
						...
						<div className="mt-12 space-y-12">
							<div className="flex hover:-translate-x-5 duration-700">
								...
								<div className="ml-4">
									<h4 className="text-2xl font-medium leading-6 text-gray-900">Experienced tour guide</h4>
							...
							<div className="flex hover:-translate-x-5 duration-700">
								...
								<div className="ml-4">
									<h4 className="text-2xl font-medium leading-6 text-gray-900">Affordable tour packages</h4>
							...
							<div className="flex hover:-translate-x-5 duration-700">
								...
								<div className="ml-4">
									<h4 className="text-2xl font-medium leading-6 text-gray-900">Explore top places over the world</h4>
