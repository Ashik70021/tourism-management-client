...
const Navbar = () => {
    ...
    return (
        <div className=" text-black bg-[#90D26D] relative z-10">
            <nav className=' navbar md:pl-8 pr-8'>
                <div className="navbar-start ">
                    <div className="dropdown">
                        ...
                        <img className='w-8 md:w-16' src="../../public/images/airplane.png" alt="" />
                        <a className="text-3xl md:text-5xl font-bold pl-2 md:pl-4">TravelVista</a>
                ...
                <div className="navbar-end">
                    ...
                    </div>
                    {
                        user ?
                            ...
                            <a href="/signin"><button type="button" className="px-8 py-3 font-semibold rounded-full bg-gray-800 text-gray-100">Signin</button></a>
